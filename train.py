...
if __name__ == '__main__':
    ...
    optim_choices = {'adam': torch.optim.Adam, 'adamw': torch.optim.AdamW} # You can try other optimizers
    model_choices = {'ver1': R34_ver1} # You can make more versions of the model

    train_annos, val_annos = split_trainval(num_train=45, num_val=10)

    # Note: For inference, you may use 5-crop (4 corners and center) - T.FiveCrop(img_size)
    img_size = 256
    crop_size = 224
    max_rotation = 30
